...
mobility_keywords = ['transport', 'car', 'ev', 'vehicle', 'autonomous', 'mobility', 'robotaxi', 'fleet', 'automotive']
        ...
        for entry in feed.entries:
            ...
            if published_parsed:
                ...
                if published_dt > one_week_ago:
                    ...
                    if "theverge.com" or "autonews.com" or "greencarcongress.com" or "harvardbusinessreview" or "smartcitiesdive.com" in url:
                        is_mobility_news = any(keyword in content_text for keyword in mobility_keywords)
                    else:
